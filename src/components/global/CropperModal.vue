...
const crop = ()=>{
   ...
   /* WORKED WITHOUT CROPPING
    const reader = new FileReader()
    reader.onload = event => {
      localStorage.setItem('imageUrl',event.target.result)
    }
    reader.readAsDataURL(croppedImageData.file); 
    croppedImageData.imageUrl=localStorage.getItem('imageUrl') 
    */
    //console.log(canvas)
